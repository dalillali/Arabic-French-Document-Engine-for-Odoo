"""Functional render smoke test for Morocco localization coexistence."""
...
class TestL10nMaRenderSmoke(ArfrRenderCase):
    def test_morocco_invoice_report_renders_with_arfr_engine(self):
        self.company.write(
            {
