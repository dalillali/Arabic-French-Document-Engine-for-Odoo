"""Functional render smoke test for Egypt localization coexistence."""
...
class TestL10nEgRenderSmoke(ArfrRenderCase):
    def test_egypt_invoice_report_renders_with_arfr_engine(self):
        self.company.write(
            {
